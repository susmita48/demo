...
import { TotalOffersComponent } from './total-offers/total-offers.component';
...
const routes: Routes = [
  ...
  //only the offers of the user
  { path: 'myOffers', component: MyOffersComponent, canActivate: [AuthGuard] },

  //all offers of the user
  {path:'totalOffers',component:TotalOffersComponent,canActivate:[AuthGuard]},
